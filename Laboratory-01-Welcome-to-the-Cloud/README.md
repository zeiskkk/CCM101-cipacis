...
- Learn how to create and organize files and folders.
...
- Created and organized folders and Markdown files.
- Created an `about-me.md` and `system-information.md` file.
- Created a public GitHub repository for my Cloud Computing portfolio.
